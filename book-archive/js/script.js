    ...
    div.innerHTML = `
        ...
        <div class="card h-100">
            ...
            <div id='card-font' class="card-body">
               ...
               <h4 class="author-name">Writer: ${book?.author_name[0]}</h4>
               <h4 class="publisher-name">Publisher: ${book?.publisher[0]}</h4>
               <h4 class="published-date"> published Year: ${book?.publish_year}</h4>
            </div>
        </div>
        `;
